...
if __name__ == '__main__':
    ...
    # inFile = "F:/temp/topics/D - data/sorted_data/software/all.review.xml"
    ...
    mem_file_results = dir_path + "mg_lda_results_magazines.mem"
    s_object_file = dir_path + "magazines.mem"
    h5_file = dir_path + "magazines.h5"
    picklefile = dir_path + "magazines.pkl"
