...
def show_results(dir_path, product):

    mem_file_results = dir_path + "mglda_"+ product+"_500.mem"
    # picklefile = dir_path + "movie_dic_words.pkl"
    # h5_file = dir_path + "movie_dw_dsw.h5"
    mem_file_counter = dir_path + product + "_counters_500.mem"
...
if __name__ == '__main__':
    ...
    dir_path = 'F:/temp/topics/R -results/15/'
    show_results(dir_path, "magazine")
